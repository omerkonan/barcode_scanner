...
print()
print()
entered_ssid = "SCANIIE"#input("Would you like to specify an SSID you'd like to use \nfor Host/Configuration mode? [default: RaspiWiFi Setup]: ")
print()
wpa_enabled_choice = True # input("Would you like WPA encryption enabled on the hotspot \nwhile in Configuration Mode? [y/N]:")
print()
...
print()
ssl_enabled_choice = False # input("Would you like to enable SSL during configuration mode \n(NOTICE: you will get a certificate ID error \nwhen connecting, but traffic will be encrypted) [y/N]?: ")
os.system('clear')
print()
print()
install_ans = True #input("Are you ready to commit changes to the system? [y/N]: ")
...
reboot_ans = True #input("Would you like to do that now? [y/N]: ")
